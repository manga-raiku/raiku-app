      ...
      <section class="trending-card dark">
        <div class="trending-card__container">
          <div class="flex items-center justify-center">
            <!-- #AD8009 #09AD6B -->
            <TrendingCardIconLeft class="text-sakura-4" />
            <!-- #8c6b1c #548c76 -->
            <span class="text-sakura-2 text-16px mx-2 text-weight-medium">{{
              $t("bang-type", [
                typesRank?.find((item) => item.value === type)?.name
              ])
            }}</span>
            <TrendingCardIconRight class="rotate-180deg text-sakura-4" />
          </div>
